...
namespace MenrisServiceReference
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="MenrisServiceReference.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<MenrisServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(MenrisServiceReference.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public MenrisServiceReference.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(MenrisServiceReference.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaRequestBody
    {
        ...
        public TCKimlikNoDogrulaRequestBody(string nationalityId, string firstName, string lastName)
        {
        }
        ...
        public TCKimlikNoDogrulaRequestBody(string nationalityId, string firstName, string lastName, int year) : this(nationalityId, firstName, lastName)
        {
            this.year = year;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public MenrisServiceReference.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(MenrisServiceReference.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public interface KPSPublicSoapChannel : MenrisServiceReference.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MenrisServiceReference.KPSPublicSoap>, MenrisServiceReference.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MenrisServiceReference.TCKimlikNoDogrulaResponse> MenrisServiceReference.KPSPublicSoap.TCKimlikNoDogrulaAsync(MenrisServiceReference.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<MenrisServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            MenrisServiceReference.TCKimlikNoDogrulaRequest inValue = new MenrisServiceReference.TCKimlikNoDogrulaRequest();
            inValue.Body = new MenrisServiceReference.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((MenrisServiceReference.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
        ...
        internal bool TCKimlikNoDogrulaAsync(string nationalityId, string v1, string v2, int year)
        {
